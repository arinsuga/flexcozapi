...
class ProjectControllerTest extends TestCase
{
    ...
    {
        $projects = [
            ['id' => 1, 'project_code' => 'PRJ001', 'project_name' => 'Project 1', 'is_active' => true],
            ['id' => 2, 'project_code' => 'PRJ002', 'project_name' => 'Project 2', 'is_active' => true],
        ];
    ...
    {
        $project = ['id' => 1, 'project_code' => 'PRJ001', 'project_name' => 'Project 1', 'is_active' => true];
    ...
    public function it_validates_required_fields_when_creating_project()
    {
        ...
        $response->assertStatus(422)
            ->assertJsonValidationErrors(['project_code', 'project_name']);
    }

    /** @test */
    public function it_validates_unique_project_code_when_creating()
    {
    ...
    public function it_updates_an_existing_project()
    {
        ...
        $existingProject = ['id' => 1, 'project_code' => 'PRJ001', 'project_name' => 'Old Name', 'is_active' => true];
        ...
        $response = $this->withoutMiddleware()
            ->putJson('/api/projects/1', $updateData);
    ...
    public function it_returns_404_when_updating_non_existent_project()
    {
        ...
        $response = $this->withoutMiddleware()
            ->putJson('/api/projects/999', ['project_name' => 'Test']);
